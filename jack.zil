...
<OBJECT NULLOBJECT
	(SYNONYM HOUSE HOME TOWN FARM STABLE SHACK GRASS SOIL GROUND LAWN PAWN SHOP WINDOW WINDOWS SIGN SIGNS PATH PATHS CLOUD CLOUDS GOLF COURSE CASINO GAME FLOOR STICK DOOR)
	(LOC GLOBAL-OBJECTS)
	(ACTION NULLOBJECT-R)
>

<ROUTINE NULLOBJECT-R ()
	<TELL "That's not something you need to worry about in this game." CR>
>
